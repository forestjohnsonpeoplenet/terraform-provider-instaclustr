...
func resourceClusterNode() *schema.Resource {
	return &schema.Resource{
		Read: resourceClusterNodeRead,
...
func resourceClusterNodeCreate(data *schema.ResourceData, meta interface{}) error {
	...
	return resourceClusterNodeRead(data, meta)
}

func resourceClusterNodeRead(data *schema.ResourceData, meta interface{}) error {
	client := meta.(*kapacitorClient.Client)
...
func resourceClusterNodeUpdate(data *schema.ResourceData, meta interface{}) error {
	client := meta.(*kapacitorClient.Client)
...
func resourceClusterNodeDelete(data *schema.ResourceData, meta interface{}) error {
	client := meta.(*kapacitorClient.Client)
